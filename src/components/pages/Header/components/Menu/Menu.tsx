...
const Menu: React.FC<Props> = ({ classNames }) => {
  ...
  return (
    <div className={`xl:hidden ${classNames}`}>
      ...
      <div
        className={`fixed z-50 top-0 left-0 right-0 bottom-0 p-3-sm flex flex-col justify-between gap-2-xs bg-bg overflow-y-auto opacity-0 -translate-y-full transition-all duration-300 ${
